...
with col1:
     batting_team = st.selectbox("Select Batting team",sorted(batballcol)+["None"],index=len(batballcol))
with col2:
     bowling_team = st.selectbox("Select Bowling team",sorted(batballcol)+["None"],index=len(batballcol))


city = st.selectbox("Place city",sorted(city)+["None"],index=len(city))
...
with col4:
     overs = st.number_input("Completed Over")
with col5:
